...
SCRAPER_PROFILES: dict[str, dict[str, Any]] = {
    "github-actions": {
        ...
        "profile_summary": (
            "Press Start on Scrapers or Hosts to run now and turn the 15-minute schedule on. "
            "Stop cancels the current run and pauses that schedule. "
            "Needs SUPABASE_DB_URL or DATABASE_URL, and SECRETS_MASTER_KEY, as GitHub Action secrets."
        ),
